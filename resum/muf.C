  ...
  */
  ...
  if (opts.mellin1d) //rapidity integrated
      ...
      for (int i = 0; i < mellinint::mdim; i++)
	{
	  ...
	  //NNNLO
	  double nf = 5.;
	  complex <double> H3st_qqb  = 2.*pow(eC1qq,2)*gamma1qq[idx]*LF + 4.*eC2qq*gamma1qq[idx]*LF + 4.*eC1qq*gamma2qq[idx]*LF + 2.*gamma3qq[idx]*LF + 2.*eC1qq*gamma1gq[idx]*gamma1qg[idx]*LF2 + beta1*gamma1qq[idx]*LF2 + 2.*beta0*eC1qq*gamma1qq[idx]*LF2 + 4.*eC1qq*pow(gamma1qq[idx],2)*LF2 + 2.*gamma1qg[idx]*gamma2gq[idx]*LF2 + 2.*beta0*gamma2qq[idx]*LF2 + 4.*gamma1qq[idx]*gamma2qq[idx]*LF2 + beta0*gamma1gq[idx]*gamma1qg[idx]*LF3 + (gamma1gg[idx]*gamma1gq[idx]*gamma1qg[idx]*LF3)/3. + (2.*pow(beta0,2)*gamma1qq[idx]*LF3)/3. + (5.*gamma1gq[idx]*gamma1qg[idx]*gamma1qq[idx]*LF3)/3. + 2.*beta0*pow(gamma1qq[idx],2)*LF3 + (4.*pow(gamma1qq[idx],3)*LF3)/3. + 2.*eC2qg*gamma1gq[idx]*LQF - 2.*pow(eC1qq,2)*gamma1qq[idx]*LQ - 4.*eC2qq*gamma1qq[idx]*LQ - 4.*eC1qq*gamma2qq[idx]*LQ - 2.*gamma3qq[idx]*LQ - 4.*eC1qq*gamma1gq[idx]*gamma1qg[idx]*LF*LQ - 2.*B2q*gamma1qq[idx]*LF*LQ - 4.*B1q*eC1qq*gamma1qq[idx]*LF*LQ + 4.*beta0*eC1qq*gamma1qq[idx]*LF*LQ - 8.*eC1qq*pow(gamma1qq[idx],2)*LF*LQ - 2.*gamma1qg[idx]*gamma2gq[idx]*LF*LQ - 2.*gamma1gq[idx]*gamma2qg[idx]*LF*LQ - 2.*B1q*gamma2qq[idx]*LF*LQ - 8.*gamma1qq[idx]*gamma2qq[idx]*LF*LQ - B1q*gamma1gq[idx]*gamma1qg[idx]*LF2*LQ - beta0*gamma1gq[idx]*gamma1qg[idx]*LF2*LQ - gamma1gg[idx]*gamma1gq[idx]*gamma1qg[idx]*LF2*LQ - B1q*beta0*gamma1qq[idx]*LF2*LQ - 5.*gamma1gq[idx]*gamma1qg[idx]*gamma1qq[idx]*LF2*LQ - 2.*B1q*pow(gamma1qq[idx],2)*LF2*LQ - 2.*beta0*pow(gamma1qq[idx],2)*LF2*LQ - 4.*pow(gamma1qq[idx],3)*LF2*LQ + 2.*eC1qq*gamma1gq[idx]*gamma1qg[idx]*LQ2 + 2.*B2q*gamma1qq[idx]*LQ2 - beta1*gamma1qq[idx]*LQ2 + 4.*B1q*eC1qq*gamma1qq[idx]*LQ2 - 6.*beta0*eC1qq*gamma1qq[idx]*LQ2 + 4.*eC1qq*pow(gamma1qq[idx],2)*LQ2 + 2.*gamma1qg[idx]*gamma2gq[idx]*LQ2 + 2.*B1q*gamma2qq[idx]*LQ2 - 2.*beta0*gamma2qq[idx]*LQ2 + 4.*gamma1qq[idx]*gamma2qq[idx]*LQ2 + 2.*B1q*gamma1gq[idx]*gamma1qg[idx]*LF*LQ2 - beta0*gamma1gq[idx]*gamma1qg[idx]*LF*LQ2 + gamma1gg[idx]*gamma1gq[idx]*gamma1qg[idx]*LF*LQ2 - A2q*gamma1qq[idx]*LF*LQ2 + pow(B1q,2)*gamma1qq[idx]*LF*LQ2 - B1q*beta0*gamma1qq[idx]*LF*LQ2 - 2.*A1q*eC1qq*gamma1qq[idx]*LF*LQ2 + 5.*gamma1gq[idx]*gamma1qg[idx]*gamma1qq[idx]*LF*LQ2 + 4.*B1q*pow(gamma1qq[idx],2)*LF*LQ2 - 2.*beta0*pow(gamma1qq[idx],2)*LF*LQ2 + 4.*pow(gamma1qq[idx],3)*LF*LQ2 - A1q*gamma2qq[idx]*LF*LQ2 - (A1q*gamma1gq[idx]*gamma1qg[idx]*LF2*LQ2)/2. - (A1q*beta0*gamma1qq[idx]*LF2*LQ2)/2. - A1q*pow(gamma1qq[idx],2)*LF2*LQ2 - B1q*gamma1gq[idx]*gamma1qg[idx]*LQ3 + beta0*gamma1gq[idx]*gamma1qg[idx]*LQ3 - (gamma1gg[idx]*gamma1gq[idx]*gamma1qg[idx]*LQ3)/3. + A2q*gamma1qq[idx]*LQ3 - pow(B1q,2)*gamma1qq[idx]*LQ3 + 2.*B1q*beta0*gamma1qq[idx]*LQ3 - (2.*pow(beta0,2)*gamma1qq[idx]*LQ3)/3. + 2.*A1q*eC1qq*gamma1qq[idx]*LQ3 - (5.*gamma1gq[idx]*gamma1qg[idx]*gamma1qq[idx]*LQ3)/3. - 2.*B1q*pow(gamma1qq[idx],2)*LQ3 + 2.*beta0*pow(gamma1qq[idx],2)*LQ3 - (4.*pow(gamma1qq[idx],3)*LQ3)/3. + A1q*gamma2qq[idx]*LQ3 + A1q*gamma1gq[idx]*gamma1qg[idx]*LF*LQ3 + A1q*B1q*gamma1qq[idx]*LF*LQ3 - (2.*A1q*beta0*gamma1qq[idx]*LF*LQ3)/3. + 2.*A1q*pow(gamma1qq[idx],2)*LF*LQ3 - (A1q*gamma1gq[idx]*gamma1qg[idx]*LQ4)/2. - A1q*B1q*gamma1qq[idx]*LQ4 + (7.*A1q*beta0*gamma1qq[idx]*LQ4)/6. - A1q*pow(gamma1qq[idx],2)*LQ4 + (pow(A1q,2)*gamma1qq[idx]*LF*LQ4)/4. - (pow(A1q,2)*gamma1qq[idx]*LQ5)/4. + eC1qg*LQF*(2.*eC1qq*gamma1gq[idx] + 2.*gamma2gq[idx] + gamma1gq[idx]*(beta0*LF + gamma1gg[idx]*LF + 3.*gamma1qq[idx]*LF - 2.*B1q*LQ + 3.*beta0*LQ - gamma1gg[idx]*LQ - 3.*gamma1qq[idx]*LQ - A1q*LQ2));
	  complex <double> H3st_qq   = (2.*LF*(6.*(eC2qg*gamma1gq[idx] + 2.*eC2qqb*gamma1qq[idx] + 2.*eC1qq*gamma2qqb[idx] + gamma3qqb[idx]) + 6.*(eC1qq*gamma1gq[idx]*gamma1qg[idx] + gamma1qg[idx]*gamma2gq[idx] + (beta0 + 2.*gamma1qq[idx])* gamma2qqb[idx])*LF + gamma1gq[idx]*gamma1qg[idx]*(3.*beta0 + gamma1gg[idx] + 5.*gamma1qq[idx])* LF2) - 6.*(2.*eC2qg*gamma1gq[idx] + 4.*eC2qqb*gamma1qq[idx] + 4.*eC1qq*gamma2qqb[idx] + 2.*gamma3qqb[idx] + 2.*(2.*eC1qq*gamma1gq[idx]*gamma1qg[idx] + gamma1qg[idx]*gamma2gq[idx] + gamma1gq[idx]*gamma2qg[idx] + B1q*gamma2qqb[idx] + 4.*gamma1qq[idx]*gamma2qqb[idx])*LF + gamma1gq[idx]*gamma1qg[idx]*(B1q + beta0 + gamma1gg[idx] + 5.*gamma1qq[idx])*LF2)*LQ + 3.*(4.*eC1qq*gamma1gq[idx]*gamma1qg[idx] + 4.*gamma1qg[idx]*gamma2gq[idx] + 4.*(B1q - beta0 + 2.*gamma1qq[idx])*gamma2qqb[idx] - 2.*A1q*gamma2qqb[idx]*LF + gamma1gq[idx]*gamma1qg[idx]*LF*(4.*B1q - 2.*beta0 + 2.*gamma1gg[idx] + 10.*gamma1qq[idx] - A1q*LF))* LQ2 - 2.*(-3*A1q*gamma2qqb[idx] + gamma1gq[idx]*gamma1qg[idx]*(3.*B1q - 3.*beta0 + gamma1gg[idx] + 5.*gamma1qq[idx] - 3.*A1q*LF))*LQ3 - 3.*A1q*gamma1gq[idx]*gamma1qg[idx]*LQ4 + 6.*eC1qg*LQF*(2.*gamma2gq[idx] + gamma1gq[idx]*(2.*eC1qq + (beta0 + gamma1gg[idx] + 3.*gamma1qq[idx])*LF - (2.*B1q - 3.*beta0 + gamma1gg[idx] + 3.*gamma1qq[idx])*LQ - A1q*LQ2)))/12.;
	  complex <double> H3st_qqp  = (2.*LF*(6.*(eC2qg*gamma1gq[idx] + 2.*eC2qqbp*gamma1qq[idx] + 2.*eC1qq*gamma2qqbp[idx] + gamma3qqbp[idx]) + 6.*(eC1qq*gamma1gq[idx]*gamma1qg[idx] + gamma1qg[idx]*gamma2gq[idx] + (beta0 + 2.*gamma1qq[idx])*gamma2qqbp[idx])*LF + gamma1gq[idx]*gamma1qg[idx]* (3.*beta0 + gamma1gg[idx] + 5.*gamma1qq[idx])*LF2) - 6.*(2.*eC2qg*gamma1gq[idx] + 4.*eC2qqbp*gamma1qq[idx] + 4.*eC1qq*gamma2qqbp[idx] + 2.*gamma3qqbp[idx] + 2.*(2.*eC1qq*gamma1gq[idx]*gamma1qg[idx] + gamma1qg[idx]*gamma2gq[idx] + gamma1gq[idx]*gamma2qg[idx] + B1q*gamma2qqbp[idx] + 4.*gamma1qq[idx]*gamma2qqbp[idx])*LF + gamma1gq[idx]*gamma1qg[idx]*(B1q + beta0 + gamma1gg[idx] + 5.*gamma1qq[idx])*LF2)*LQ + 3.*(4.*eC1qq*gamma1gq[idx]*gamma1qg[idx] + 4.*gamma1qg[idx]*gamma2gq[idx] + 4.*(B1q - beta0 + 2.*gamma1qq[idx])*gamma2qqbp[idx] - 2.*A1q*gamma2qqbp[idx]*LF + gamma1gq[idx]*gamma1qg[idx]*LF*(4.*B1q - 2.*beta0 + 2.*gamma1gg[idx] + 10.*gamma1qq[idx] - A1q*LF))* LQ2 - 2.*(-3*A1q*gamma2qqbp[idx] + gamma1gq[idx]*gamma1qg[idx]* (3.*B1q - 3.*beta0 + gamma1gg[idx] + 5.*gamma1qq[idx] - 3.*A1q*LF))*LQ3 - 3.*A1q*gamma1gq[idx]*gamma1qg[idx]*LQ4 + 6.*eC1qg*LQF* (2.*gamma2gq[idx] + gamma1gq[idx]*(2.*eC1qq + (beta0 + gamma1gg[idx] + 3.*gamma1qq[idx])*LF - (2.*B1q - 3.*beta0 + gamma1gg[idx] + 3.*gamma1qq[idx])*LQ - A1q*LQ2)))/12.;
	  complex <double> H3st_qqbp = (2.*LF*(6.*(eC2qg*gamma1gq[idx] + 2.*eC2qqp*gamma1qq[idx] + 2.*eC1qq*gamma2qqp[idx] + gamma3qqp[idx]) + 6.*(eC1qq*gamma1gq[idx]*gamma1qg[idx] + gamma1qg[idx]*gamma2gq[idx] + (beta0 + 2.*gamma1qq[idx])* gamma2qqp[idx])*LF + gamma1gq[idx]*gamma1qg[idx]*(3.*beta0 + gamma1gg[idx] + 5.*gamma1qq[idx])* LF2) - 6.*(2.*eC2qg*gamma1gq[idx] + 4.*eC2qqp*gamma1qq[idx] + 4.*eC1qq*gamma2qqp[idx] + 2.*gamma3qqp[idx] + 2.*(2.*eC1qq*gamma1gq[idx]*gamma1qg[idx] + gamma1qg[idx]*gamma2gq[idx] + gamma1gq[idx]*gamma2qg[idx] + B1q*gamma2qqp[idx] + 4.*gamma1qq[idx]*gamma2qqp[idx])*LF + gamma1gq[idx]*gamma1qg[idx]*(B1q + beta0 + gamma1gg[idx] + 5.*gamma1qq[idx])*LF2)*LQ + 3.*(4.*eC1qq*gamma1gq[idx]*gamma1qg[idx] + 4.*gamma1qg[idx]*gamma2gq[idx] + 4.*(B1q - beta0 + 2.*gamma1qq[idx])*gamma2qqp[idx] - 2.*A1q*gamma2qqp[idx]*LF + gamma1gq[idx]*gamma1qg[idx]*LF*(4.*B1q - 2.*beta0 + 2.*gamma1gg[idx] + 10.*gamma1qq[idx] - A1q*LF))* LQ2 - 2.*(-3*A1q*gamma2qqp[idx] + gamma1gq[idx]*gamma1qg[idx]*(3.*B1q - 3.*beta0 + gamma1gg[idx] + 5.*gamma1qq[idx] - 3.*A1q*LF))*LQ3 - 3.*A1q*gamma1gq[idx]*gamma1qg[idx]*LQ4 + 6.*eC1qg*LQF*(2.*gamma2gq[idx] + gamma1gq[idx]*(2.*eC1qq + (beta0 + gamma1gg[idx] + 3.*gamma1qq[idx])*LF - (2.*B1q - 3.*beta0 + gamma1gg[idx] + 3.*gamma1qq[idx])*LQ - A1q*LQ2)))/12.;
	  complex <double> H3st_qg   = (12.*eC1qq*(2.*eC1qg*gamma1gg[idx] + 2.*eC1qq*gamma1qg[idx] + 2.*gamma2qg[idx] + gamma1qg[idx]*(gamma1gg[idx] + gamma1qq[idx])*LQF)*LQF + 12.*eC1qg*(2.*eC1qg*gamma1gq[idx] + 2.*eC1qq*gamma1qq[idx] + 2.*gamma2qq[idx] + (gamma1gq[idx]*gamma1qg[idx] + pow(gamma1qq[idx],2))*LQF)*LQF - 6.*A1q*gamma1qg[idx]*(gamma1gg[idx] + gamma1qq[idx])*LQ4 + 12.*beta0*LQF*((2.*gamma2qg[idx] + gamma1qg[idx]*(gamma1gg[idx] + gamma1qq[idx])*LQF)* (LF + LQ) + eC1qg*gamma1gg[idx]*(LF + 3.*LQ) + eC1qq*gamma1qg[idx]*(LF + 3.*LQ)) + 12.*gamma1qq[idx]*LQF*(2.*eC2qg + (2.*eC1qq*gamma1qg[idx] + 2.*gamma2qg[idx] + gamma1qg[idx]*(gamma1gg[idx] + gamma1qq[idx])*LQF)*LQF + beta0*eC1qg*(LF + 3.*LQ) + eC1qg*(2.*gamma1gg[idx]*LF - 2.*(B1q + gamma1gg[idx])*LQ - A1q*LQ2)) + 12.*gamma1qg[idx]*LQF* (2.*eC2qq + LF*(2.*(eC1qg*gamma1gq[idx] + eC1qq*gamma1qq[idx] + gamma2qq[idx]) + (gamma1gq[idx]*gamma1qg[idx] + pow(gamma1qq[idx],2))*LF) - 2.*(eC1qg*gamma1gq[idx] + gamma2qq[idx] + gamma1gq[idx]*gamma1qg[idx]*LF + (B1q + gamma1qq[idx])*(eC1qq + gamma1qq[idx]*LF))*LQ + (gamma1gq[idx]*gamma1qg[idx] + 2.*B1q*gamma1qq[idx] + pow(gamma1qq[idx],2) - A1q*(eC1qq + gamma1qq[idx]*LF))*LQ2 + A1q*gamma1qq[idx]*LQ3 + beta0*(LF*(eC1qq + 2.*gamma1qq[idx]*LF) + 3.*eC1qq*LQ - 2.*gamma1qq[idx]*LQ2)) + gamma1qg[idx]*LQF*(12.*beta1*(LF + LQ) + 8.*pow(beta0,2)*(LF2 + LF*LQ + LQ2) - 2.*beta0*LQ*(6.*B1q*(LF + 2.*LQ) + A1q*LQ*(3.*LF + 7.*LQ)) + 3.*LQ*(-8*B2q + LQ*(-4*A2q + pow(2.*B1q + A1q*LQ,2)))) - 24.*LQ*(eC2qg*gamma1gg[idx] + eC1qg*gamma2gg[idx] + eC1qq*gamma2qg[idx] + gamma3qg[idx] + gamma1qg[idx]*(eC2qq + eC2qqb + (eC2qqbp + eC2qqp)*(-1 + nf))) + 4.*gamma1qg[idx]*LF3*(pow(gamma1gg[idx],2) + gamma1gg[idx]*gamma1qq[idx] + pow(gamma1qq[idx],2) + 2.*gamma1gq[idx]*gamma1qg[idx]*nf) + 24.*LF*(eC2qg*gamma1gg[idx] + eC2qq*gamma1qg[idx] + eC2qqb*gamma1qg[idx] - (eC2qqbp + eC2qqp)*gamma1qg[idx] + eC1qg*gamma2gg[idx] + eC1qq*gamma2qg[idx] + gamma3qg[idx] - B1q*(eC1qg*gamma1gg[idx] + eC1qq*gamma1qg[idx] + gamma2qg[idx])* LQ + B1q*gamma1qg[idx]*(gamma1gg[idx] + gamma1qq[idx])*LQ2 + (LQ*(-2.*(eC1qg*pow(gamma1gg[idx],2) + eC1qq*gamma1qg[idx]*(gamma1gg[idx] + gamma1qq[idx]) + (gamma1gg[idx] + gamma1qq[idx])*gamma2qg[idx] + gamma1qg[idx]*(gamma2gg[idx] + gamma2qq[idx] + gamma2qqb[idx] - gamma2qqbp[idx] - gamma2qqp[idx])) + gamma1qg[idx]*(pow(gamma1gg[idx],2) + gamma1gg[idx]*gamma1qq[idx] + pow(gamma1qq[idx],2))*LQ - A1q*(eC1qg*gamma1gg[idx] + eC1qq*gamma1qg[idx] + gamma2qg[idx])*LQ + A1q*gamma1qg[idx]*(gamma1gg[idx] + gamma1qq[idx])*LQ2))/2. + gamma1qg[idx]*(eC2qqbp + eC2qqp - LQ*(2.*eC1qg*gamma1gq[idx] + gamma2qqbp[idx] + gamma2qqp[idx] - gamma1gq[idx]*gamma1qg[idx]*LQ))*nf) + 12.*LQ2*(eC1qq*gamma1gg[idx]*gamma1qg[idx] + eC1qq*gamma1qg[idx]*gamma1qq[idx] + 2.*gamma1qg[idx]*gamma2gg[idx] + 2.*gamma1qq[idx]*gamma2qg[idx] + 2.*B1q*(eC1qg*gamma1gg[idx] + eC1qq*gamma1qg[idx] + gamma2qg[idx]) + eC1qg*(pow(gamma1gg[idx],2) + 2.*gamma1gq[idx]*gamma1qg[idx]*nf)) + 4.*LQ3*(3.*A1q*(eC1qg*gamma1gg[idx] + eC1qq*gamma1qg[idx] + gamma2qg[idx]) - gamma1qg[idx]*(pow(gamma1gg[idx],2) + gamma1gg[idx]*gamma1qq[idx] + pow(gamma1qq[idx],2) + 3.*B1q*(gamma1gg[idx] + gamma1qq[idx]) + 2.*gamma1gq[idx]*gamma1qg[idx]*nf)) - 6.*LF2*(-2.*eC1qq*gamma1qg[idx]*(gamma1gg[idx] + gamma1qq[idx]) - 4.*gamma1qg[idx]*gamma2gg[idx] - 4.*gamma1qq[idx]*gamma2qg[idx] - 2.*eC1qg*(pow(gamma1gg[idx],2) + 2.*gamma1gq[idx]*gamma1qg[idx]*nf) + gamma1qg[idx]*LQ*(2.*(gamma1gg[idx]*(B1q + gamma1gg[idx]) + (B1q + gamma1gg[idx])*gamma1qq[idx] + pow(gamma1qq[idx],2)) + A1q*(gamma1gg[idx] + gamma1qq[idx])*LQ + 4.*gamma1gq[idx]*gamma1qg[idx]*nf)))/24.;

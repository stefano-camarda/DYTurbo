...
const double resconst::Z3 = 1.20205690315959428540;
const double resconst::Z4 = 1.08232323371113819152;
const double resconst::Z5 = 1.03692775514336992633;
...
double resconst::A1q, resconst::A2q, resconst::A3q, resconst:: A4q, resconst::B1q, resconst::B2q, resconst::C1qqn, resconst::B3q;
...
void resconst::init()
{
  ...
  //double A4q_th = 1553./256. //Pade approximant from https://arxiv.org/pdf/hep-ph/0506288.pdf
  double A4q_th = 0.42441*0.0133*pow(M_PI,4); //from Eq. (4.3) of https://arxiv.org/pdf/1805.09638.pdf
  ...
  B3q=(7358.86 -721.516*NF + 20.5951* nf2)/64.; // from https://arxiv.org/pdf/1604.01404.pdf

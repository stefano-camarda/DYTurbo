...
void test_CentralLeptonCut(){
    ...
    for ( double pt3 : { 10., 30. })
        for ( double pt4 : { 10., 30. })
            for ( double y3 : { 1., 5. })
                for ( double y4 : { 1., 5. }){
                    // set lep kinem
                    ...
                    if (cutC!=cutF){
                        printf (" NOT SAME decission cutC %d cutF %d  pt3 %g pt4 %g y3 %g y4 %g \n", cutC, cutF, pt3, pt4, y3, y4);
                        //} else {
                        //printf (" same decission cutC %d cutF %d  pt3 %g pt4 %g y3 %g y4 %g \n", cutC, cutF, pt3, pt4, y3, y4);
                    }
                }
}
